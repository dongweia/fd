		    ...
		    >			
				<div class="hm-commodity-display-card" >
					<div class="itemWrap">
						...
						<div class="iconfriendsHelpWrap" style="left: 200rpx;" @tap="deletecommodity" >删除</div>
						<div class="iconfriendsHelpWrap" style="right: 200rpx;" @tap="updatecommodity">编辑</div>
					</div>
				</div>	    
		</luPopupWrapper>
		</mescroll-uni>	
			...
			getdata(){
				...
				if(value){				
				  	uni.request({
						...
						data:{
							'mid':0, //address无值 且mid为0代表自己发布的商品   
