<template>
    <view class="uni-page-body" style="box-sizing: border-box;">
        ...
        <button type="default" style="width: 100%;" @tap="send">提交修改</button>
        ...
        methods: {
            ...
            send() {
				...
				uni.uploadFile({
				    ...
				    url: config.httpUrl+'/api/v1/updatecommodity', 
				    filePath:tmp,
					formData:{
						"id":id,
						"title":form.title,						
						...
						data:{
				  	    ...
				  	    success: (res) => {
				  			...
				  			if(jsondata.code=='0'){
								...
								this.form.title=jsondata.data["title"]
								this.form.text=jsondata.data["describe"]
