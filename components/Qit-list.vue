		...
		<luPopupWrapper ref="luPopupWrapper" 
		    ...
		    >			
				<div class="hm-commodity-display-card" >
					<div class="itemWrap">
						<image class="item" s :src="winimage" />		         
						...
						<div class="iconfriendsHelpWrap" style="left: 150rpx;" @tap="collect">收藏</div>
						<div class="iconfriendsHelpWrap" @tap="chat">交流</div>
						<div class="iconfriendsHelpWrap" @tap="order" style="right: 150rpx;">下单</div>
					</div>
				</div>	    
		</luPopupWrapper>
	</view>
	...
	export default {
		...
		methods: {
			...
			collect(){
				...
				if(value){
				  	uni.request({
				  	    url: config.httpUrl +'/api/v1/commodity/collect',
				  		method:"POST",
				  	    header: {
				  		   'Authorization' : value,
				  	    },
